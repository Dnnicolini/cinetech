...
<div class="container mt-4">
    ...
    <form action="/generos/update/<?= $filme['id']; ?>" method="POST" enctype="multipart/form-data">
    <div class="mb-3">
            <label for="nome" class="form-label">Nome</label>
            <input type="text" class="form-control" value="<?= htmlspecialchars($filme['nome']); ?>" name="nome" required>
        </div>
